...
export interface ApiEjexrepEjexrep extends Struct.CollectionTypeSchema {
  collectionName: 'ejexreps';
  info: {
    description: '';
    displayName: 'Ejexrep';
    pluralName: 'ejexreps';
    singularName: 'ejexrep';
  };
  options: {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Rep: Schema.Attribute.Integer;
    rutine: Schema.Attribute.Relation<'manyToOne', 'api::rutine.rutine'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiUserAppUserApp extends Struct.CollectionTypeSchema {
  collectionName: 'user_apps';
  info: {
    description: '';
    displayName: 'User_app';
